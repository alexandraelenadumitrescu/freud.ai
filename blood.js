...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Play bat sound on load, but only if user interacts with the page (modern browser policy)
  // The actual play() call is in the button click handler for user interaction.

  enterSiteButton.addEventListener("click", () => {
    initialWelcomeOverlay.classList.add("hidden");
    // Attempt to play sound after user interaction
    if (batSound) {
...
let isSoundOn = false; // Initial state: sound off
